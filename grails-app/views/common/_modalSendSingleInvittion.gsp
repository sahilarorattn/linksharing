<div class="modal fade" id="sendInvitationSingleTemplate" tabindex="-1" role="dialog"
                ...
                <g:form class="form-horizontal" role="form" controller="topic" action="sendInvitation"  id="sendInvitation" name="sendInvitation">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control"
                                       id="tname" name="tname" readonly="readonly"/>
                                ...
                                <input type="hidden" class="form-control" value="${tid}"
                                       id="topicInv" name="topicInv"/>
                            </div>
                        </div>
                    </div>
                    <!-- Modal Footer -->
