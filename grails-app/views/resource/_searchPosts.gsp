<div id="listTemplateDivId2">
    <g:each in="${searchPostsList}" var="topicPostsDTO" status="i">
    ...
    <div class="paginateButtons">
        ...
        <util:remotePaginate controller="resource" action="searchPaginatedPosts" total="${countPosts}"
                             update="listTemplateDivId2"
                             id="${searchText}"
